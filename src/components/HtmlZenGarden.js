        ...
        {!containerWidth ? (
          ...
          >
            <motion.div
              ...
              initial={false}
              animate={{
                borderRadius: getThemeValue('wrapper.borderRadius'),
              }}
            >
              ...
              >
                ...
                >
                  ...
                  <div className={`relative ${themes[theme].heading}`}>
                    ...
                    >
                      <span className="hidden sm:inline whitespace-pre">Classic</span>Utility Jacket
                    </motion.h2>
                    <motion.h2
                      layout
                      className={clsx(
                ...
                <div
                  ...
                  style={{
                    gridTemplateColumns: getThemeValue('button.grid'),
                  }}
                >
